...
Commanders are always on the board. Losing your commander means defeat.
...
Every card has:
- **Initiative (1–10):** Determines resolution order.
- **Top Ability:** Primary command.
- **Bottom Ability:** Secondary command.

When resolving, you pick **one card's top ability** and the **other card's bottom ability**.

### Card Types

#### Standard Commands
- **March:** Move units.
- **Engage:** Attack with units.
...
- Draw a line from attacker to target.
- If any hex along the line is blocked by a unit or obstacle, the shot is blocked.

### Push / Displacement

Some abilities push targets 1 hex away. The target must move to a valid empty hex. If no valid hex exists, the push does nothing.
...
**Q: Can I play two cards from my hand and resolve both tops or both bottoms?**
A: No. You must resolve the top of one card and the bottom of the other.
