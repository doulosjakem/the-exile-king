...
EXPECTED_PROMPTS = {
    ...
    "box-art-board-of-war": "game box art, painting in illuminated manuscript style, a stone between two boulders serves as a crude war table, on it a crude clay map, David leans in with three captains pointing, skin scrolls lean against the rocks, punchy ink strokes minimal color, hand-painted historical illustration, aged parchment background with ink outlines, muted earth tones ochre umber, board game cover art, family friendly, NOT medieval, NOT fantasy, NOT European, historically accurate bronze age Levantine, NO text, NO logo, NO 3D render, NO photograph, NO anime, NO cartoon, NO modern objects, NO modern clothing, NO European armor, NO chainmail, NO plate armor, NO castle, NO heraldry, NO coat of arms, NO glowing effects, NO neon, NO bright colors",
...
# Aliases: map prompt keys used in generation queues to existing EXPECTED_PROMPTS entries
EXPECTED_PROMPTS["aid"] = EXPECTED_PROMPTS["refugee-aid"]
EXPECTED_PROMPTS["eleazar"] = EXPECTED_PROMPTS["mighty-eleazar"]
EXPECTED_PROMPTS["shammah"] = EXPECTED_PROMPTS["mighty-sham"]
EXPECTED_PROMPTS["leadership"] = EXPECTED_PROMPTS["davids-leadership"]
EXPECTED_PROMPTS["commander-aura"] = EXPECTED_PROMPTS["commander-aura-marker"]
EXPECTED_PROMPTS["box-art-the-cave-of-engedi"] = EXPECTED_PROMPTS["box-art-round3-the-cave-of-engedi"]
EXPECTED_PROMPTS["box-art-B"] = EXPECTED_PROMPTS["box-art-board-of-war"]

# New command card ability prompts (missing from EXPECTED_PROMPTS)
EXPECTED_PROMPTS["bodyguard-protect"] = "scene in illuminated manuscript style, bronze age Levantine elite bodyguards standing in protective formation around their commander, bronze scale armor and hide shields, spears braced, loyal protective expressions, aged parchment background, ink outlines with muted watercolor wash in umber and ochre, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["covered-retreat"] = "scene in illuminated manuscript style, bronze age Levantine Israelite forces conducting a disciplined retreat under cover of shield wall, rear guard holding off pursuers, linen tunics and leather armor, dust and motion, aged parchment background, ink outlines with muted watercolor wash in ochre and faded crimson, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["desert-ambush"] = "scene in illuminated manuscript style, bronze age Levantine Israelite warriors lying in wait behind rocky outcrops in the desert, spears and shields ready, enemy figures visible on the horizon, dust and heat haze, aged parchment background, ink outlines with muted watercolor wash in ochre and umber, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["desperate-charge"] = "scene in illuminated manuscript style, bronze age Levantine Israelite warriors charging with desperation, bronze short swords raised, dust and motion, determined expressions, linen tunics and leather vests, aged parchment background, ink outlines with muted watercolor wash in ochre and faded crimson, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["focused-volley"] = "scene in illuminated manuscript style, bronze age Levantine Israelite slingers and archers concentrating fire on a single target, leather slings and composite bows drawn, projectiles arcing through air, focused determined expressions, linen tunics and leather vests, aged parchment background, ink outlines with muted watercolor wash in ochre and umber, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["harassment-campaign"] = "scene in illuminated manuscript style, bronze age Levantine Israelite skirmishers harrying enemy flanks from rocky terrain, leather slings raised, stones in pouches, hit-and-run tactics, alert predatory expressions, dust and motion, aged parchment background, ink outlines with muted watercolor wash in ochre and umber, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["hold-line"] = "scene in illuminated manuscript style, bronze age Levantine Israelite spearmen and swordsmen holding the line against a charging enemy, shields locked, spears braced, grim determined expressions, linen tunics and leather armor, dust and motion, aged parchment background, ink outlines with muted watercolor wash in umber and faded crimson, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["iron-wall"] = "scene in illuminated manuscript style, bronze age Levantine Israelite shield bearers forming an impenetrable wall, large round hide shields locked together, bronze rims gleaming, steadfast unyielding expressions, linen tunics and leather armor, brown cloaks, aged parchment background, ink outlines with muted watercolor wash in umber and ochre, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["locked-shields"] = "scene in illuminated manuscript style, bronze age Levantine Israelite warriors locking shields in tight formation, large round hide shields overlapping, bronze rims, protective stance, determined expressions, linen tunics and leather armor, aged parchment background, ink outlines with muted watercolor wash in umber and faded crimson, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["loyal-bond"] = "scene in illuminated manuscript style, bronze age Levantine warriors standing shoulder to shoulder in loyal formation, shields overlapping, weapons ready, bond of loyalty and brotherhood, determined expressions, linen tunics and leather vests, brown cloaks, aged parchment background, ink outlines with muted watercolor wash in ochre and umber, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["rally"] = "scene in illuminated manuscript style, bronze age Levantine Israelite commander raising his arm in rallying cry, soldiers gathering around him with weapons ready, determination and unity, simple cloth banner on wooden pole, linen tunics and leather armor, brown wool cloaks, aged parchment background, ink outlines with muted watercolor wash in ochre and brown, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["reconnaissance"] = "scene in illuminated manuscript style, bronze age Levantine Israelite scouts moving stealthily through rocky terrain, light clothing, scanning horizon, short spears and slings at ready, alert watchful expressions, dust and heat haze, aged parchment background, ink outlines with muted watercolor wash in ochre and umber, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["relentless-advance"] = "scene in illuminated manuscript style, bronze age Levantine Israelite warriors advancing relentlessly across rocky terrain, shields forward, spears and swords raised, dust at their heels, determined expressions, linen tunics and leather vests, brown cloaks, aged parchment background, ink outlines with muted watercolor wash in ochre and faded crimson, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
EXPECTED_PROMPTS["tribe-charge"] = "scene in illuminated manuscript style, bronze age Levantine tribal warriors charging as one, spears and swords raised, dust and motion, fierce determined expressions, linen tunics and leather armor, brown wool cloaks, aged parchment background, ink outlines with muted watercolor wash in ochre and faded crimson, hand-painted historical illustration, board game card art, family friendly, NOT medieval, NOT fantasy, NOT European"
