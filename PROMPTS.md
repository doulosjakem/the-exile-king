...
## Unit Token Icons (512×512, then downscale to 256×256 in Unity)
...
9. **Downscale tokens in Unity** — generate at 512×512, set Pixels Per Unit to match the board scale
