...
|---|---|---|
| Initiative | 7 | 3 |
| Effect | Command Jonathan: move and attack. All Loyal Guards within 2 tiles gain 1 Shield this turn. | Command Jonathan: grant one Elite Archer within 2 tiles the ability to attack twice this turn. |
