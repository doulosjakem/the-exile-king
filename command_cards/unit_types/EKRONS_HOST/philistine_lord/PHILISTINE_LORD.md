...
|---|---|---|
| Initiative | 6 | 4 |
| Effect | Command Philistine Lord: move up to 2, then attack. Adjacent allies gain +1 attack this turn. | Grant one Champion or Heavy Infantry within 2 tiles an extra activation. |

**Notes:** In the prototype pair with Chariots or Shield Bearers when no Champion is available.
