# Amalekites — Command Cards

> **Faction Philosophy:** Fast-moving desert raiders. Hit hard and fast, then disengage. Poor defensive capability but high mobility.

---

## Faction Overview

The Amalekites are the major campaign enemy. Fast-moving desert raiders who raid Ziklag and harass David's forces across the southern frontier.

Available in **MVP** (enemy only).
...
| Unit | Type | Notes |
|---|---|---|
| Chieftain | Commander | Fast leader |
